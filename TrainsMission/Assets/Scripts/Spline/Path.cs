...
public class Path
{
    ...
    public void AddSegment(Vector2 anchorPos)
    {
        ...
        if(autoSetControlPoints)
        {
            AutoSetAllAffectedControllPoints(points.Count - 1);
        }
    ...
    public void SplitSegment(Vector2 anchorPos, int segmentIndex)
    {
        ...
        if(autoSetControlPoints)
        {
            AutoSetAllAffectedControllPoints(segmentIndex * 3 + 3);
        }
        else
        {
    ...
    public void MovePoint(int i, Vector2 pos)
    {
        ...
        if (i % 3==0 || !autoSetControlPoints)
        {
            ...
            if (autoSetControlPoints)
            {
                AutoSetAllAffectedControllPoints(i);
            }
            else
            {
                if (i % 3 == 0)
    ...
    void AutoSetAllAffectedControllPoints(int updatedAchnorIndex)
    {
        for(int i = updatedAchnorIndex -3; i <= updatedAchnorIndex+3; i+=3)
        {
